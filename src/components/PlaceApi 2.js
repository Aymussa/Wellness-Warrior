...
function PlaceFinder() {
  ...
  <div>
    <form onSubmit={handlePlaceFinder}>
      ...
      <input className="block w-64 border border-gray-300 rounded-sm py-2 px-3 mt-1"
        type="text"
        id="city"
        value={city}
      ...
      <select className="block w-64 border border-gray-300 rounded-sm py-2 px-3 mt-1"
        id="select"
        value={select}
      ...
      <button className="bg-teal-600 hover:bg-pink-600 text-white font-bold mt-4" type="submit">
        Submit
      </button>
    </form>
  </div>
